...
/**
Base implementation of the WorktableCellItem protocol. Provides default values,
basic functionality, and empty method implementations so that extending classes
can implement only the functionality they need.
