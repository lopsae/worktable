...
public protocol WorktableCellItem {
	...
	/**
	Class or nibName of the cellView for this cellItem. This object is used by
	the WorktableViewController to register the class or nib that will be used
	to create cellViews for the instance.
	
	If viewSource is a String object it will be interpreted as the name of the
	nib to use in the default bundle.

	If viewSource is a Class type it must be a class extending UITableViewCell.
	...
	*/
	...
	It is important that the value returned is the same through the lifetime of
	the cellItem in a table. That is, while a cellItem is contained by a table
	its estimated height should not change.
